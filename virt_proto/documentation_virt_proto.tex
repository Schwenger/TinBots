...
As default model of operation, there's the Right Hand Follower, which does not keep track of previous locations, but just applies the right hand rule until another component has a better idea what to do.

FIXME

\subsubsection{Sensor Filter}
This component \enquote{filters}
