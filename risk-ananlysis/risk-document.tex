...
\subsubsection{Path Pruning}
 %
Module that shall detect and determine when RHR is about to walk in circles.
 %
\begin{description}
\item[Failure Rate:] 0
 %
...
\item[Source:] Resistor Failure Rate model \footnote{\url{http://www.sqconline.com/resistor-mtbf-mil-hdbk-217-rev-f-notice-2}}.
\end{description}
