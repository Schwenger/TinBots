...
\section{Overview}
After a major catastrophe a brave team of robots is sent out to save a damsel in distress. The collapsed building is simulated by a maze in which the victim, impersonated by a teddy bear, waits for it's rescue. The maze is laid out on a table, the remaining walls are build of paper, some of which contain holes as windows or broken down beams of wood or steal. Will they save the day?
